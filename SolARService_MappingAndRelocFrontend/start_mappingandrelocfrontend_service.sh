...
export XPCF_GRPC_SERVER_URL=0.0.0.0:50055
...
for modulePath in $(grep -o "\$XPCF_MODULE_ROOT.*lib" SolARService_MappingAndRelocFrontend_modules.xml)
do
...
LD_LIBRARY_PATH=$ld_library_path ./SolARService_MappingAndRelocFrontend -m SolARService_MappingAndRelocFrontend_modules.xml -p SolARService_MappingAndRelocFrontend_properties.xml $@
