...
IF "%2"=="" (
    ECHO You need to give Relocalization Markers Service URL as second parameter!
    GOTO end
) ELSE (
...
IF "%3"=="" (
    ECHO You need to give Mapping Service URL as third parameter!
    GOTO end
) ELSE (
...
SET RELOCALIZATION_MARKERS_SERVICE_URL=%2

REM Set Mapping Service URL
SET MAPPING_SERVICE_URL=%3
