...
static const char* SolARMappingAndRelocalizationProxy_method_names[] = {
  ...
  "/com.bcom.solar.gprc.SolARMappingAndRelocalizationProxy/SetCameraRigParameters",
  "/com.bcom.solar.gprc.SolARMappingAndRelocalizationProxy/RelocalizeAndMap",
  "/com.bcom.solar.gprc.SolARMappingAndRelocalizationProxy/RelocalizeAndMapStereo",
...
SolARMappingAndRelocalizationProxy::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_SetCameraRigParameters_(SolARMappingAndRelocalizationProxy_method_names[4], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_RelocalizeAndMap_(SolARMappingAndRelocalizationProxy_method_names[5], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_RelocalizeAndMapStereo_(SolARMappingAndRelocalizationProxy_method_names[6], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
...
::grpc::Status SolARMappingAndRelocalizationProxy::Stub::SetCameraRigParameters(::grpc::ClientContext* context, const ::com::bcom::solar::gprc::CameraRigParameters& request, ::com::bcom::solar::gprc::Empty* response) {
  return ::grpc::internal::BlockingUnaryCall< ::com::bcom::solar::gprc::CameraRigParameters, ::com::bcom::solar::gprc::Empty, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_SetCameraRigParameters_, context, request, response);
}

void SolARMappingAndRelocalizationProxy::Stub::experimental_async::SetCameraRigParameters(::grpc::ClientContext* context, const ::com::bcom::solar::gprc::CameraRigParameters* request, ::com::bcom::solar::gprc::Empty* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::com::bcom::solar::gprc::CameraRigParameters, ::com::bcom::solar::gprc::Empty, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_SetCameraRigParameters_, context, request, response, std::move(f));
}

void SolARMappingAndRelocalizationProxy::Stub::experimental_async::SetCameraRigParameters(::grpc::ClientContext* context, const ::com::bcom::solar::gprc::CameraRigParameters* request, ::com::bcom::solar::gprc::Empty* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_SetCameraRigParameters_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::com::bcom::solar::gprc::Empty>* SolARMappingAndRelocalizationProxy::Stub::PrepareAsyncSetCameraRigParametersRaw(::grpc::ClientContext* context, const ::com::bcom::solar::gprc::CameraRigParameters& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::com::bcom::solar::gprc::Empty, ::com::bcom::solar::gprc::CameraRigParameters, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_SetCameraRigParameters_, context, request);
}

::grpc::ClientAsyncResponseReader< ::com::bcom::solar::gprc::Empty>* SolARMappingAndRelocalizationProxy::Stub::AsyncSetCameraRigParametersRaw(::grpc::ClientContext* context, const ::com::bcom::solar::gprc::CameraRigParameters& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncSetCameraRigParametersRaw(context, request, cq);
  result->StartCall();
  return result;
}

::grpc::Status SolARMappingAndRelocalizationProxy::Stub::RelocalizeAndMap(::grpc::ClientContext* context, const ::com::bcom::solar::gprc::Frame& request, ::com::bcom::solar::gprc::RelocalizationResult* response) {
  return ::grpc::internal::BlockingUnaryCall< ::com::bcom::solar::gprc::Frame, ::com::bcom::solar::gprc::RelocalizationResult, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_RelocalizeAndMap_, context, request, response);
}

void SolARMappingAndRelocalizationProxy::Stub::experimental_async::RelocalizeAndMap(::grpc::ClientContext* context, const ::com::bcom::solar::gprc::Frame* request, ::com::bcom::solar::gprc::RelocalizationResult* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::com::bcom::solar::gprc::Frame, ::com::bcom::solar::gprc::RelocalizationResult, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_RelocalizeAndMap_, context, request, response, std::move(f));
}

void SolARMappingAndRelocalizationProxy::Stub::experimental_async::RelocalizeAndMap(::grpc::ClientContext* context, const ::com::bcom::solar::gprc::Frame* request, ::com::bcom::solar::gprc::RelocalizationResult* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::com::bcom::solar::gprc::RelocalizationResult>* SolARMappingAndRelocalizationProxy::Stub::PrepareAsyncRelocalizeAndMapRaw(::grpc::ClientContext* context, const ::com::bcom::solar::gprc::Frame& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::com::bcom::solar::gprc::RelocalizationResult, ::com::bcom::solar::gprc::Frame, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_RelocalizeAndMap_, context, request);
}

::grpc::ClientAsyncResponseReader< ::com::bcom::solar::gprc::RelocalizationResult>* SolARMappingAndRelocalizationProxy::Stub::AsyncRelocalizeAndMapRaw(::grpc::ClientContext* context, const ::com::bcom::solar::gprc::Frame& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
::grpc::Status SolARMappingAndRelocalizationProxy::Stub::RelocalizeAndMapStereo(::grpc::ClientContext* context, const ::com::bcom::solar::gprc::Frames& request, ::com::bcom::solar::gprc::RelocalizationResult* response) {
  return ::grpc::internal::BlockingUnaryCall< ::com::bcom::solar::gprc::Frames, ::com::bcom::solar::gprc::RelocalizationResult, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_RelocalizeAndMapStereo_, context, request, response);
}

void SolARMappingAndRelocalizationProxy::Stub::experimental_async::RelocalizeAndMapStereo(::grpc::ClientContext* context, const ::com::bcom::solar::gprc::Frames* request, ::com::bcom::solar::gprc::RelocalizationResult* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::com::bcom::solar::gprc::Frames, ::com::bcom::solar::gprc::RelocalizationResult, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_RelocalizeAndMapStereo_, context, request, response, std::move(f));
}

void SolARMappingAndRelocalizationProxy::Stub::experimental_async::RelocalizeAndMapStereo(::grpc::ClientContext* context, const ::com::bcom::solar::gprc::Frames* request, ::com::bcom::solar::gprc::RelocalizationResult* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_RelocalizeAndMapStereo_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::com::bcom::solar::gprc::RelocalizationResult>* SolARMappingAndRelocalizationProxy::Stub::PrepareAsyncRelocalizeAndMapStereoRaw(::grpc::ClientContext* context, const ::com::bcom::solar::gprc::Frames& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::com::bcom::solar::gprc::RelocalizationResult, ::com::bcom::solar::gprc::Frames, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_RelocalizeAndMapStereo_, context, request);
}

::grpc::ClientAsyncResponseReader< ::com::bcom::solar::gprc::RelocalizationResult>* SolARMappingAndRelocalizationProxy::Stub::AsyncRelocalizeAndMapStereoRaw(::grpc::ClientContext* context, const ::com::bcom::solar::gprc::Frames& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncRelocalizeAndMapStereoRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
SolARMappingAndRelocalizationProxy::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< SolARMappingAndRelocalizationProxy::Service, ::com::bcom::solar::gprc::CameraRigParameters, ::com::bcom::solar::gprc::Empty, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](SolARMappingAndRelocalizationProxy::Service* service,
             ::grpc::ServerContext* ctx,
             const ::com::bcom::solar::gprc::CameraRigParameters* req,
             ::com::bcom::solar::gprc::Empty* resp) {
               return service->SetCameraRigParameters(ctx, req, resp);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      SolARMappingAndRelocalizationProxy_method_names[5],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< SolARMappingAndRelocalizationProxy::Service, ::com::bcom::solar::gprc::Frame, ::com::bcom::solar::gprc::RelocalizationResult, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](SolARMappingAndRelocalizationProxy::Service* service,
             ::grpc::ServerContext* ctx,
             const ::com::bcom::solar::gprc::Frame* req,
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< SolARMappingAndRelocalizationProxy::Service, ::com::bcom::solar::gprc::Frames, ::com::bcom::solar::gprc::RelocalizationResult, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](SolARMappingAndRelocalizationProxy::Service* service,
             ...
             ::com::bcom::solar::gprc::RelocalizationResult* resp) {
               return service->RelocalizeAndMapStereo(ctx, req, resp);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
...
::grpc::Status SolARMappingAndRelocalizationProxy::Service::SetCameraRigParameters(::grpc::ServerContext* context, const ::com::bcom::solar::gprc::CameraRigParameters* request, ::com::bcom::solar::gprc::Empty* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status SolARMappingAndRelocalizationProxy::Service::RelocalizeAndMap(::grpc::ServerContext* context, const ::com::bcom::solar::gprc::Frame* request, ::com::bcom::solar::gprc::RelocalizationResult* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status SolARMappingAndRelocalizationProxy::Service::RelocalizeAndMapStereo(::grpc::ServerContext* context, const ::com::bcom::solar::gprc::Frames* request, ::com::bcom::solar::gprc::RelocalizationResult* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
