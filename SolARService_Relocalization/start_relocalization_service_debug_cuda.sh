...
export XPCF_GRPC_SERVER_URL=0.0.0.0:60052
...
LD_LIBRARY_PATH=$ld_library_path ./SolARService_Relocalization -m SolARService_Relocalization_modules.xml -p SolARService_Relocalization_properties.xml -t cuda $@
