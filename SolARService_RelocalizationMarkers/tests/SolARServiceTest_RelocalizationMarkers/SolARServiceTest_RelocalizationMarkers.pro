...
SOURCES += \
    SolARServiceTest_RelocalizationMarkers.cpp
...
config_files.files =  $$files($${PWD}/SolARServiceTest_RelocalizationMarkers_conf.xml)

INSTALLS += config_files

DISTFILES += \
    SolARServiceTest_RelocalizationMarkers_conf.xml \
